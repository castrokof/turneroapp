    ...
    <div class="login-card">
        ...
        <div class="login-body">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('display.index')); ?>" class="text-muted">
                    <i class="fas fa-tv mr-1"></i> Ver Pantalla Pública
                </a>
                <span class="mx-2">|</span>
                <a href="<?php echo e(route('display.kiosk')); ?>" class="text-muted">
...
<?php /**PATH C:\xampp\htdocs\turneroapp\resources\views/auth/login.blade.php ENDPATH**/ ?>