                    ...
                    <div class="row">
                        <?php $__currentLoopData = $groupSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 mb-3">
                                ...
                                <?php elseif($setting->key === 'tv_message' || $setting->key === 'kiosk_message'): ?>
                                    <textarea class="form-control"
                                              id="settings_<?php echo e($setting->key); ?>"
                                              name="settings[<?php echo e($setting->key); ?>]"
                                              rows="2"
                                              placeholder="<?php echo e($setting->key === 'kiosk_message' ? 'Ej: Bienvenidos a nuestra clínica' : 'Ej: Bienvenidos. Por favor espere su turno.'); ?>"><?php echo e($setting->value); ?></textarea>
                                <?php elseif($setting->key === 'tv_logo_url' || $setting->key === 'tv_video_url'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\turneroapp\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>