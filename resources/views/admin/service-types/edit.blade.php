...
@section('title', 'Editar Servicio - Sistema de Turnos')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-edit mr-2"></i>Editar: {{ $serviceType->name }}
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="prefix" id="prefix" class="form-control @error('prefix') is-invalid @enderror"
                                       value="{{ old('prefix', $serviceType->prefix) }}" required maxlength="5" style="text-transform: uppercase;">
                                @error('prefix')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="color" name="color" id="color" class="form-control @error('color') is-invalid @enderror"
                                       value="{{ old('color', $serviceType->color) }}" required style="height: 40px;">
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="estimated_time" id="estimated_time"
                                       ...
                                       value="{{ old('estimated_time', $serviceType->estimated_time) }}" required min="1" max="480">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="daily_limit" id="daily_limit"
                                       ...
                                       value="{{ old('daily_limit', $serviceType->daily_limit) }}" min="1" placeholder="Sin límite">
                                @error('daily_limit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="requires_appointment" name="requires_appointment"
                                           {{ old('requires_appointment', $serviceType->requires_appointment) ? 'checked' : '' }}>
