...
<body>
    ...
    <div class="welcome-screen" id="welcomeScreen" onclick="startKiosk()">
        ...
        <h1 class="welcome-title">{{ $settings['business_name'] }}</h1>

        @if(isset($settings['kiosk_message']) && $settings['kiosk_message'])
            <p class="welcome-subtitle">{{ $settings['kiosk_message'] }}</p>
        @else
