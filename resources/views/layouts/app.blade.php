    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column mt-3">
            @if(auth()->user()->isAdmin())
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.service-windows.*') ? 'active' : '' }}" href="{{ route('admin.service-windows.index') }}">
            ...
            <hr class="my-2 mx-3 bg-secondary">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('display.index') }}" target="_blank">
                    <i class="fas fa-tv"></i> Pantalla Pública
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('display.kiosk') }}" target="_blank">
                    <i class="fas fa-tablet-alt"></i> Kiosko
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('display.tv') }}" target="_blank">
    ...
    <div class="main-content">
        ...
        <nav class="top-navbar d-flex justify-content-between align-items-center">
            <div>
                ...
                <span class="ml-2">@yield('page-title', 'Dashboard')</span>
            </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <span class="dropdown-item-text text-muted">{{ ucfirst(auth()->user()->role) }}</span>
